...
if(!mysqli_query($db,$query))
{
  ...
  die('<h1 class="error" style="border: 1px solid black;
			width: 800px;
			margin: 40px auto;
			background: #f4f4f4;
			color: red;
			...
			<p style="font-size: 20px;text-align: center;"><a href="InsertBook.php?Email=sanjayucp1554@gmail.com&Password=sanjay004">Go to the previous page</a></p>
			</h1>
...
function myFunction()
{
alert("Book Successfully Inserted"); // this is the message in ""
}
</script>
