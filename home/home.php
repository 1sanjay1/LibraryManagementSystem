...
<body>
   ...
   <div id="TopBar2">
            <div class="NavigationBar">
               <ul>
                  ...
                  <li><a href="#">Login</a>
                     <ul>
                        <li><a href="UserLogin/UserLogin.php">Student Login</a></li>
                        <li><a href="AdminLogin/AdminLogin1.php">Admin Login</a></li>
                     </ul>
                  </li>
               </ul>
   ...
   <div id="MiddleBar">
     ...
     <div id="middle_image" >
        <img src="Library-quote-by-Anne-Herbert.jpg" height="100%" width="100%" style="overflow:hidden;"/>
     </div>
